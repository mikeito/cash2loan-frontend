    ...
    <section className="px-4 md:px-0">
      ...
      <main className="md:container mx-auto">
        ...
        <section className="w-full md:w-3/4 my-7">
          <div className="flex flex-col space-y-7 md:mr-10">
            <h2 className="text-gray-900 text-6xl font-bold">Topics</h2>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row items-center justify-between">
              ...
              <div class="relative w-full md:w-56">
                ...
                <input
                  type="text"
                  class="bg-white border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <section className="flex flex-row gap-3">
          ...
          {/* right content */}
          <div className="w-1/4 flex -mt-4 flex-col hidden md:block">  {/* add pt-6 */} 
            <h2 className="text-sm uppercase mb-4 text-gray-600">
              trending stories
            </h2>
            <div className="flex flex-col gap-3">
            <div className="flex flex-row gap-2 items-center">
              <img class="w-20 h-12 rounded-md" src="images/man.jpg" alt="" />
